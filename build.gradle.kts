...
plugins {
    ...
    id("earth.terrarium.cloche") version "0.14.1"
}
...
group = "settingdust.calypsos_void_heart"
    ...
    run fabric@{
        ...
        targets.withType<FabricTarget> {
            ...
            metadata {
                entrypoint("main") {
                    adapter = "kotlin"
                    value = "$group.fabric.CalypsosVoidHeartFabric::init"
                }

                entrypoint("client") {
                    adapter = "kotlin"
                    value = "$group.fabric.CalypsosVoidHeartFabric::clientInit"
                }
